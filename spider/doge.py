...
url_day = "https://api.huobi.pro/market/history/kline?period=1day&size=2000&symbol=dogeusdt"

url_1min = "https://api.huobi.pro/market/history/kline?period=1min&size=1&symbol=dogeusdt"
url_1day = "https://api.huobi.pro/market/history/kline?period=1day&size=1&symbol=dogeusdt"


oid = '32EEECA277231D4180E7A764E1085AC2'

oid_day = 'E5FF614EDEE17548AB1F1AA3154A4DCA'

oid_10s = 'E5FF614EDEE17548AB1F1AA3154A4DCA'
...
while True:
    ...
    # 更新表格行情
    if int(time.mktime(now.timetuple())) - int(time.mktime(prev_10s.timetuple())) >= 20:
        prev_10s = now
